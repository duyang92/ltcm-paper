...
#define MAXI 4294967295
   ...
   public:
    ...
    DS(int k, double memory, uint32_t len, uint32_t* seeds, int hh_th = 8000) {
        srand((int)time(0));
    ...
    DS(int n, int m, double memory, uint32_t len, uint32_t* seeds, int hh_th = 8000) {
        srand((int)time(0));
